...
public class Ae2EntropyManipulatorRecipe extends BasicEmiRecipe {
    ...
    public Ae2EntropyManipulatorRecipe(EntropyRecipe source) {
        super(Ae2Categories.ENTROPY, source.getId(),  130, 50);
        ...
        inputConsumed = oB != null && oB.defaultBlockState().isAir()
        ...
        if (fluid != null) {
            ...
            if (!fluid.isSource(fluid.defaultFluidState())) {
                if (fluid instanceof FlowingFluid flowingFluid) {
                    ...
                    Ae2EmiMod.LOGGER.warn("Don't know how to get the source fluid for {}", fluid);
